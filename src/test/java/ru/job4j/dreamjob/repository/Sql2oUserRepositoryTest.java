...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        var user = sql2oUserRepository.save(new User(0, "name",
                "email", "password"));
    ...
    @Test
    public void whenTryToSaveUserWithExistingEmailThenGetEmptyObject() {
        sql2oUserRepository.save(new User(0, "name",
                "email", "password"));
        var savedUser = sql2oUserRepository.save(new User(1, "name1",
                "email", "password1"));
